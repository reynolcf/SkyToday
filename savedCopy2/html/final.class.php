 ...
 */
	...
	public static function addTransaction($request, $weather1, $weather2, $openai1)

	{
			try {
				EXEC_SQL("insert into transactions (request, weather1, weather2, openai1) values (?,?,?,?)");
				$retData["status"]=0;
				$retData["message"]="insert of '$request', '$weather1', '$weather2', and '$openai1' into transaction";
			}
			catch  (Exception $e) {
				$retData["status"]=1;
				$retData["message"]=$e->getMessage();
